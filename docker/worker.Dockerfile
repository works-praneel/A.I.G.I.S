...
RUN pip install --no-cache-dir bandit semgrep pylint safety wafw00f checksec.py

# 3. Node.js security tools
RUN npm install -g eslint retire

# 4. Ruby security tools
...
# 17. Application code (last — maximises Docker layer cache)
